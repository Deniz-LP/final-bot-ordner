...
module.exports = (client) => {
    //try {
		let allCommands = [];
        readdirSync("C:/Users/Deniz/Documents/GitHub/final-bot-ordner/src/slashCommands/").forEach((dir) => {
			if(lstatSync(`C:/Users/Deniz/Documents/GitHub/final-bot-ordner/src/slashCommands/${dir}`).isDirectory()) {
				const groupName = dir;
				...
				if(cmdSetup && cmdSetup.Folder) {
					...
					const slashCommands = readdirSync(`C:/Users/Deniz/Documents/GitHub/final-bot-ordner/src/slashCommands/${dir}/`).filter((file) => file.endsWith(".js"));
					for (let file of slashCommands) {
						let pull = require(`C:/Users/Deniz/Documents/GitHub/final-bot-ordner/src/slashCommands/${dir}/${file}`);
				...
				let pull = require(`C:/Users/Deniz/Documents/GitHub/final-bot-ordner/src/slashCommands/${dir}`);
				if (pull.name && pull.description) {
